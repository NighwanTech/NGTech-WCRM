...
export default async function CitySEOPage({ params }: { params: Promise<{ city: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground relative">
      ...
      {/* CTA Footer Banner - Ultra High Contrast & Attractive Buttons */}
      <section className="py-20 bg-gradient-to-br from-emerald-700 via-emerald-800 to-emerald-950 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 max-w-4xl text-center space-y-6 relative z-10">
          ...
          <p className="text-emerald-100 text-base max-w-xl mx-auto font-medium">
            Get started in 10 minutes with your 14-day free trial. Talk to our team directly.
          </p>
