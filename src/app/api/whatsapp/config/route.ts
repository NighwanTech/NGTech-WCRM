...
export async function PATCH(request: Request) {
  try {
    ...
    if (ai_auto_reply_enabled !== undefined) updateFields.ai_auto_reply_enabled = ai_auto_reply_enabled
    if (ai_auto_reply_prompt !== undefined) updateFields.ai_auto_reply_prompt = ai_auto_reply_prompt
    if (ai_knowledge_base !== undefined) updateFields.ai_knowledge_base = ai_knowledge_base
    if (sla_enabled !== undefined) updateFields.sla_enabled = sla_enabled
    if (sla_first_reply_min !== undefined) updateFields.sla_first_reply_min = sla_first_reply_min
    if (sla_subsequent_reply_min !== undefined) updateFields.sla_subsequent_reply_min = sla_subsequent_reply_min
...
export async function POST(request: Request) {
  try {
    ...
    const baseRow: Record<string, any> = {
      ...
      ai_auto_reply_enabled: ai_auto_reply_enabled ?? false,
      ai_auto_reply_prompt: ai_auto_reply_prompt ?? 'You are a helpful customer support assistant for this business.',
