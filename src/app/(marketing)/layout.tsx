...
import { AiWcrmLogo } from '@/components/brand/aiwcrm-logo'
    ...
    <div className="flex min-h-screen flex-col bg-background font-sans selection:bg-primary/30 text-foreground overflow-x-clip">
        ...
        <div className="container mx-auto flex h-16 sm:h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-8 min-w-0">
            <Link href="/" className="flex items-center shrink-0 group">
              <img src="/logo.svg" alt="AI WCRM Logo" className="h-10 sm:h-12 w-auto object-contain transition-transform duration-300 group-hover:scale-[1.03]" />
            </Link>

            <nav className="hidden items-center gap-0.5 xl:gap-1 xl:flex shrink-0">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className="relative group px-2 lg:px-2.5 py-2 text-[11px] xl:text-[12px] font-semibold tracking-wide uppercase text-muted-foreground hover:text-foreground transition-colors duration-200"
                >
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <a
              ...
              className="hidden lg:inline-flex items-center gap-2 text-xs font-semibold text-[#25D366] bg-[#25D366]/10 hover:bg-[#25D366] hover:text-white px-4 py-2 rounded-full border border-[#25D366]/20 transition-all duration-300"
            >
      ...
      <footer className="relative border-t border-border/40 bg-card/50 backdrop-blur-sm overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-10 md:grid-cols-4 lg:grid-cols-6">
            ...
            <div className="col-span-2 lg:col-span-2 pr-8">
              <Link href="/" className="flex items-center mb-5 group">
                <img src="/logo.svg" alt="AI WCRM Logo" className="h-12 sm:h-14 w-auto object-contain transition-transform duration-300 group-hover:scale-[1.02]" />
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="tel:+918985025794" className="inline-flex items-center gap-2 text-muted-foreground/80 hover:text-emerald-500 font-semibold transition-colors duration-200">
          ...
          {/* WCRM AVAILABLE CITIES ACROSS INDIA SEO FOOTER LINKS */}
          <div className="mt-12 border-t border-border/30 pt-8 space-y-3">
            <h4 className="text-[11px] font-extrabold uppercase tracking-wider text-muted-foreground/80">
              WCRM AVAILABLE CITIES ACROSS INDIA:
            </h4>
            <div className="flex flex-wrap gap-y-1.5 gap-x-2 text-[11px] text-muted-foreground/70 leading-relaxed">
              {[
                ...
                <React.Fragment key={c.slug}>
                  ...
                  {i < arr.length - 1 && <span className="text-muted-foreground/40 font-normal">|</span>}
                </React.Fragment>
              ))}
            </div>
          </div>
          ...
          {/* Bottom bar */}
          <div className="mt-8 flex flex-col items-center justify-between border-t border-border/30 pt-6 sm:flex-row">
