 ...
 */
export function UniversalOmnichannelInbox() {
  ...
  const [selectedThread, setSelectedThread] = useState<InboxThread>(threads[0])
  ...
  return (
    <Card className="border bg-card shadow-xs text-xs overflow-hidden">
      ...
      <CardContent className="p-0 grid grid-cols-1 md:grid-cols-3 min-h-[380px]">
        {/* Left Thread List */}
        <div className="border-r p-2 space-y-1 bg-muted/10">
