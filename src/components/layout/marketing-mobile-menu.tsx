      ...
      {isOpen && (
        <div className="absolute top-[80px] sm:top-[96px] left-0 w-full bg-background border-b border-border/50 shadow-2xl flex flex-col p-6 gap-6 z-50 animate-in slide-in-from-top-2">
          ...
          <div className="flex flex-col gap-4 pt-4 border-t border-border/50">
            ...
            <a href="https://wa.me/918092225777" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp" className="text-lg font-bold text-white bg-[#25D366] hover:bg-[#128C7E] px-4 py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md mt-2">
