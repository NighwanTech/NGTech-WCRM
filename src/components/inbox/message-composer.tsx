...
export function MessageComposer({
  ...
  }, [externalDraft, onConsumeExternalDraft]);
  ...
  }, [text, sending, sessionExpired, onSend, replyTo?.id, onTyping]);
  ...
  return (
    <div className="border-t border-border bg-card p-3">
      ...
      <QuoteModal
        ...
        contactId={contactId}
        onQuoteGenerated={(msg) => onSend(msg)}
      />
      <MeetingModal
        open={meetingModalOpen}
        onOpenChange={setMeetingModalOpen}
        contactId={contactId}
        onMeetingGenerated={(msg) => onSend(msg)}
      />
    </div>
  );
}
