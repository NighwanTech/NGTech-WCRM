  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (isEdit && contactId) {
        ...
        // Route new contacts through the server API so plan limits
        // and account suspension are enforced before the insert.
        ...
        contactId = result.id
        // Tags already handled server-side for new contacts
